...
#ifndef CONTROL_CORE_POLYNOMIAL_TRAJECTORY_H
#define CONTROL_CORE_POLYNOMIAL_TRAJECTORY_H

#include <control_core/trajectory/piecewise_trajectory_base.h>
...
public:
  ...
  // polynomials are allways scalar, we interpolate each dimension separately!
...
#endif // CONTROL_CORE_POLYNOMIAL_TRAJECTORY_H
