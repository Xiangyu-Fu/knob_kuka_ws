#ifndef LWR_CONTROLLERS_CARTESIAN_CONTROLLER_H
#define LWR_CONTROLLERS_CARTESIAN_CONTROLLER_H
...
// actions
#include <kuka_msgs/MoveToCartesianAction.h>
...
namespace lwr_controllers
{
  ...
  class CartesianController : public controller_interface::KinematicChainControllerBase<hardware_interface::PositionJointInterface>
  {
  public:
    typedef actionlib::ActionServer<kuka_msgs::MoveToCartesianAction> ActionServer;
    typedef std::shared_ptr<ActionServer> ActionServerPtr;
    typedef ActionServer::GoalHandle GoalHandle;
    typedef realtime_tools::RealtimeServerGoalHandle<kuka_msgs::MoveToCartesianAction> RealtimeGoalHandle;
    typedef boost::shared_ptr<RealtimeGoalHandle> RealtimeGoalHandlePtr;
    typedef cc::CartesianStateSlerpTrajectory Trajectory ;
  ...
  private:
    ...
    cc::CartesianState x_des_;  // desired jointstate
    ...
    TrajectoryPtr trajectory_;                  // traj
